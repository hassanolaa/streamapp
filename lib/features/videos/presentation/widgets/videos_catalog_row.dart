...
class VideosCatalogRow extends StatefulWidget {
  final String catalogName;
  final List<StreamSummaryModel> videos;
  final int catalogIndex;

  const VideosCatalogRow({
    super.key,
  ...
  @override
  State<VideosCatalogRow> createState() => _VideosCatalogRowState();
}

class _VideosCatalogRowState extends State<VideosCatalogRow> {
...
class _ModernVideoCard extends StatefulWidget {
  final StreamSummaryModel video;
              ...
              Container(
                ...
                child: Stack(
                  children: [
                    ...
                    // Live Badge
                    if (widget.video.streamType?.contains('LIVE') == true ||
